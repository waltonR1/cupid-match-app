<template>
  <view class="min-h-screen bg-page-base text-text-heading">
    ...
    <view class="relative overflow-hidden bg-auth-hero text-text-heading">
      <view class="pointer-events-none absolute left-[-72px] top-[-48px] h-[240px] w-[240px] rounded-full bg-brand-highlight/10 blur-[88px]" />
      ...
      <view class="mx-auto max-w-[1280px] px-8 pb-20 pt-10 lg:pb-24 lg:pt-12">
        <view class="grid gap-12 lg:min-h-[680px] lg:grid-cols-[1.06fr_0.94fr] lg:items-start">
          <view class="max-w-[720px]">
            ...
            <view class="mt-12 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              <view
                  ...
                  :key="item.title"
                  class="border border-border-base/70 bg-surface-card/18 px-5 py-5 backdrop-blur transition-all duration-300 hover:-translate-y-[2px] hover:border-border-highlight/50"
              >
          ...
          <view class="relative lg:ml-auto lg:w-full lg:max-w-[520px]">
            ...
            <view class="relative border border-border-base/70 bg-surface-elevated/32 px-8 py-8 shadow-hero backdrop-blur">
              <view>
                <view class="text-[12px] uppercase tracking-[4px] text-brand-brown">
                  {{ labels.formTitle }}
                </view>
              ...
              <view class="mt-8 grid gap-5">
                <view
                    ...
                    :key="field.label"
                    class="border border-border-base/60 bg-surface-elevated/52 px-5 py-4"
                >
