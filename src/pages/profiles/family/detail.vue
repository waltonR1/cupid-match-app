  ...
  <AppPageLayout>
    <view class="mx-auto max-w-[1180px] px-5 pb-20 pt-6 lg:px-8 lg:pb-24 lg:pt-8">
      ...
      <view class="mb-5 flex items-center justify-between">
        ...
        <view
          v-if="canFavorite"
          class="inline-flex cursor-pointer items-center gap-1 border border-semantic-border-default bg-semantic-surface-card px-3 py-2 text-[12px] tracking-[1px] transition-colors duration-200 hover:border-semantic-border-emphasis"
          :class="[favorite.isFavorite ? 'text-semantic-state-danger' : 'text-semantic-text-muted', favoriteLoading ? 'pointer-events-none opacity-50' : '']"
