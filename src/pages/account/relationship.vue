            ...
            >
              ...
              <view class="min-w-0">
                <view class="flex flex-wrap items-center gap-2">
                  ...
                  <view class="text-[14px] text-semantic-text-secondary">{{ formatLocalizedAge(locale, favorite.age) }}</view>
                </view>
                ...
                <view class="mt-3 line-clamp-2 text-[14px] leading-6 text-semantic-text-muted">{{ favorite.summary }}</view>
