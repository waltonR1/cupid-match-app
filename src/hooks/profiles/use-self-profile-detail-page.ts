...
import { mapSelfProfileDetailPage } from '@/mappers/profiles/profile-detail.mapper'
...
export function useSelfProfileDetailPage(profileId: Ref<string>, t: Translate, locale: Ref<FormatLocale>) {
  ...
  const pageData = computed(() => mapSelfProfileDetailPage(profile.value, locale.value, t))
