...
export const contactMessages: AppLocaleMessages = {
  zh: {
    hero: {
      ...
      title: '联系我们',
      titleAccent: 'Contact',
      description: '无论你是想了解平台定位、咨询顾问服务、升级会员、报名活动，还是讨论品牌合作，都可以从这里开始。',
      secondaryDescription: '我们希望每一次联系都清晰、体面，并且能够进入合适的服务承接。',
      actions: {
        primary: '咨询顾问',
      },
    ...
    info: {
      ...
      card1: {
        title: '电子邮箱',
        desc: '适合平台介绍、合作咨询、会员与活动相关问题。',
        value: '{email}',
      },
      card2: {
        title: '微信顾问',
        desc: '适合更直接的会员咨询、活动报名沟通和初步顾问交流。',
        value: 'RencontreParis',
      },
      card3: {
        title: '所在城市',
        desc: '平台以巴黎为起点，线下活动和品牌落地优先围绕法国与欧洲展开。',
        value: 'Paris / France',
      },
    },
    cases: {
      ...
      card1: {
        title: '平台介绍咨询',
        desc: '了解平台定位、目标用户、多语言支持与使用方式。',
      },
      card2: {
        title: '会员升级咨询',
        desc: '咨询白银、黄金、钻石会员的差异与升级流程。',
      },
      card3: {
        title: '活动报名与合作',
        desc: '了解巴黎及欧洲活动、定向局、主题活动与合作可能。',
      },
      card4: {
        title: '顾问或红娘服务',
        desc: '针对认真关系导向用户，沟通更深入的一对一顾问支持或牵线服务。',
      },
      card5: {
        title: '家庭参与咨询',
        desc: '家庭成员可了解平台规则、参与边界与家长沙龙等内容。',
      },
      card6: {
        title: '品牌与商务合作',
        desc: '媒体合作、场地合作、活动联办和品牌联名都可以从这里进入。',
      },
    },
    guide: {
      eyebrow: 'Guidance',
