  ...
  profiles: {
    ...
    detail: {
      ...
      fields: {
        ...
        phone: 'Telephone', email: 'Email', wechat: 'WeChat', preferredChannel: 'Contact prefere', contactVisibility: 'Visibilite du contact', role: 'Role de gestion', relationshipToProfile: 'Lien avec la personne', isPrimary: 'Profil principal',
      },
      values: {
