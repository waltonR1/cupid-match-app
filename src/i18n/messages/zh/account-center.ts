...
export const accountCenterMessages: AppMessageSchema = {
  ...
  settings: {
    ...
    security: { title: '登录与安全', boundAccounts: '绑定账号', password: '密码', passwordSet: '已设置密码', passwordUnset: '未设置密码', passwordNote: '密码修改需前往登录页', verified: '已验证', unverified: '未验证', unbound: '未绑定', lastChangedAt: '最近修改', neverChanged: '暂无记录', canReset: '可重置', requiresMfa: '敏感操作需二次验证' },
    notifications: '通知',
    ...
    actions: { upgrade: '升级', edit: '编辑设置', cancelEdit: '取消编辑', save: '保存设置', viewTerms: '服务条款', viewPrivacy: '隐私说明', exportData: '导出我的数据', deactivateAccount: '停用账户' },
    actionHints: {
      exportData: '申请导出平台保存的账户与资料数据。',
      deactivateAccount: '通过受控流程暂停账户访问与对外曝光。',
    },
    placeholders: { preferredCity: '未设置' },
    toasts: { saved: '已保存', saveFailed: '保存失败，请重试', comingSoon: '功能开发中' },
    validation: { accountNameRequired: '请输入账户名称' },
