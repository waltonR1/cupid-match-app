    ...
    detail: {
      ...
      values: {
        language: {
          ...
          AR: '阿拉伯语', PT: '葡萄牙语', RU: '俄语', DE: '德语',
          JA: '日语', KO: '韩语', HI: '印地语', IT: '意大利语',
          NL: '荷兰语', TR: '土耳其语', VI: '越南语', TH: '泰语',
          PL: '波兰语', SV: '瑞典语', EL: '希腊语', HE: '希伯来语',
          ID: '印尼语', MS: '马来语', BN: '孟加拉语', FA: '波斯语',
          UR: '乌尔都语', YUE: '粤语', TA: '泰米尔语', TE: '泰卢固语',
          MR: '马拉地语', GU: '古吉拉特语', PA: '旁遮普语', TL: '他加禄语',
          KM: '高棉语', MY: '缅甸语', LO: '老挝语', MN: '蒙古语',
          NE: '尼泊尔语', SI: '僧伽罗语', AM: '阿姆哈拉语', SW: '斯瓦希里语',
          RO: '罗马尼亚语', HU: '匈牙利语', CS: '捷克语', SK: '斯洛伐克语',
          BG: '保加利亚语', SR: '塞尔维亚语', HR: '克罗地亚语', UK: '乌克兰语',
          NO: '挪威语', DA: '丹麦语', FI: '芬兰语', LT: '立陶宛语',
          LV: '拉脱维亚语', ET: '爱沙尼亚语', SL: '斯洛文尼亚语', IS: '冰岛语',
          CA: '加泰罗尼亚语', HY: '亚美尼亚语', KA: '格鲁吉亚语', AZ: '阿塞拜疆语',
          KK: '哈萨克语', UZ: '乌兹别克语', KY: '吉尔吉斯语', PS: '普什图语',
          KU: '库尔德语', HT: '海地克里奥尔语', MT: '马耳他语', GA: '爱尔兰语',
          CY: '威尔士语', ML: '马拉雅拉姆语', KN: '卡纳达语', OR: '奥里亚语',
          FIL: '菲律宾语', AF: '南非荷兰语', MI: '毛利语', MG: '马达加斯加语',
          SO: '索马里语', SM: '萨摩亚语', SD: '信德语', TK: '土库曼语',
        },
        ...
        profileStatus: { draft: '草稿', review: '审核中', open: '公开', paused: '暂停', hidden: '隐藏' },
        ...
        relationshipValues: {
          honesty: '诚实', trust: '信任', communication: '沟通', respect: '尊重',
          loyalty: '忠诚', family: '家庭', growth: '共同成长', support: '相互支持',
          humor: '幽默', ambition: '事业心', kindness: '善良', independence: '独立',
          romance: '浪漫', stability: '稳定',
        },
