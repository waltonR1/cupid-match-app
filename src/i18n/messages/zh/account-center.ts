...
export const accountCenterMessages: AppMessageSchema = {
  ...
  profiles: {
    ...
    visibilityField: {
      ...
      hasChildren: '是否有孩子',
      childrenPlan: '子女计划',
      acceptsLongDistance: '是否接受异地',
      relationshipPlan: '关系规划',
      residencePlan: '定居规划',
      relocationWillingness: '迁居意愿',
      values: '价值观',
      preferredAgeMin: '偏好最低年龄',
      preferredAgeMax: '偏好最高年龄',
      locationScope: '地域范围',
    ...
    visibilityCustom: {
      emptyValue: '沿用平台默认策略',
      emptyDescription: '当前还没有个性化可见性设置，资料按平台默认策略展示。',
    },
  ...
  settings: {
    ...
    account: '账户信息',
    accountFields: { accountName: '账户名称', accountId: '账户编号', status: '账户状态', preferredLocale: '偏好语言', createdAt: '创建时间', updatedAt: '更新时间' },
    ...
    actions: { upgrade: '升级', viewTerms: '服务条款', viewPrivacy: '隐私说明', exportData: '导出我的数据', deactivateAccount: '停用账户' },
    actionHints: {
