...
export const accountCenterMessages: AppMessageSchema = {
  ...
  membership: {
    ...
    conciergePriority: '顾问优先级',      entitlementDescription: {
      ...
      cancelRenewal: { title: '取消自动续费？', description: '当前会员权益会保留到本周期结束，之后 Stripe 不会再续订这笔订阅。', success: '已取消自动续费，当前会员权益会保留到本周期结束。' },
      actions: { upgrade: '升级会员', viewSystem: '查看会员体系', cancelRenewal: '取消自动续费' },
  },
