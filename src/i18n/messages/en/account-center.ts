...
export const accountCenterMessages: AppMessageSchema = {
  ...
  profiles: {
    ...
    permission: { owner: 'Editable', manager: 'Manageable' },
    ...
    detail: {
      ...
      fields: {
        ...
        phone: 'Phone', email: 'Email', wechat: 'WeChat', preferredChannel: 'Preferred contact', contactVisibility: 'Contact visibility', role: 'Management role', relationshipToProfile: 'Relationship to profile', isPrimary: 'Primary profile',
      },
      values: {
