...
export const homeMessages: AppLocaleMessages = {
  zh: {
    ...
    features: {
      ...
      parent: {title: '家庭协助', desc: '为希望参与了解与沟通的家庭，提供更清晰、更克制的支持入口。', label: 'Espace Famille'},
    ...
    profilesPreview: {
      ...
      item1: {
        ...
        meta: '32 岁 · 品牌策略',
        goal: '认真关系',
        summary: '重视沟通质量与生活节奏，希望在真实互动中判断长期关系的可能性。',
        city: '巴黎',
        education: '硕士',
        languages: '法语 / 英语 / 中文',
        tag1: '艺术展',
      ...
      item2: {
        ...
        meta: '34 岁 · 产品顾问',
        goal: '长期发展',
        summary: '更偏理性与稳定，希望认识价值观接近、愿意认真进入现实关系的人。',
        city: '巴黎 / 上海',
        education: '硕士',
        languages: '中文 / 英语 / 法语',
        tag1: '阅读',
      ...
      item3: {
        ...
        meta: '30 岁 · 建筑设计',
        goal: '高质量相遇',
        summary: '喜欢在活动和对话中慢慢了解彼此，不追求表面热闹，更看重真实契合。',
        city: '里昂',
        education: '建筑学院',
        languages: '法语 / 英语',
        tag1: '设计',
  ...
  fr: {
    ...
    features: {
      ...
      parent: {title: 'Espace famille', desc: 'Un accès plus clair et plus mesuré pour les familles qui souhaitent accompagner avec bienveillance.', label: 'Espace Famille'},
    ...
    profilesPreview: {
      ...
      item1: {
        initials: 'L',
        name: 'Lucie',
        meta: '32 ans · Stratégie de marque',
        goal: 'Relation sérieuse',
        summary: 'Attentive à la qualité du dialogue et au rythme de vie, elle préfère juger une relation à travers des échanges réels.',
        city: 'Paris',
        education: 'Master',
        languages: 'Français / Anglais / Chinois',
        tag1: 'Expositions',
        tag2: 'Vin',
        tag3: 'Vision long terme',
        label: 'Profil Sélectionné',
      },
      ...
      item2: {
        initials: 'C',
        name: 'Chen',
        meta: '34 ans · Conseil produit',
        goal: 'Projet durable',
        summary: 'Une approche posée et stable, tournée vers des personnes dont les valeurs et les intentions sont clairement alignées.',
        city: 'Paris / Shanghai',
        education: 'Master',
      ...
      item3: {
        initials: 'A',
        name: 'Amélie',
        meta: '30 ans · Architecture',
        goal: 'Rencontre de qualité',
        summary: 'Elle préfère découvrir quelqu’un dans la durée, à travers les activités et les conversations, plutôt que dans la précipitation.',
        city: 'Lyon',
        education: 'École d’architecture',
  ...
  en: {
    ...
    features: {
      ...
      parent: {title: 'Family support', desc: 'A clearer and more respectful entry point for families who wish to support the process.', label: 'Espace Famille'},
    ...
    profilesPreview: {
      ...
      item1: {
        initials: 'L',
        name: 'Lucie',
        meta: '32 · Brand Strategy',
        goal: 'Serious relationship',
        summary: 'She values thoughtful conversation and compatible life rhythm, and prefers to judge connection through real interaction.',
        city: 'Paris',
        education: 'Master’s degree',
        languages: 'French / English / Chinese',
        tag1: 'Art shows',
        tag2: 'Wine',
        tag3: 'Long-term mindset',
      ...
      item2: {
        initials: 'C',
        name: 'Chen',
        meta: '34 · Product Advisor',
        goal: 'Long-term path',
        summary: 'Calm and grounded, looking for someone with aligned values and a clear intention toward a real relationship.',
        city: 'Paris / Shanghai',
        education: 'Master’s degree',
      ...
      item3: {
        initials: 'A',
        name: 'Amélie',
        meta: '30 · Architecture',
        goal: 'Meaningful encounter',
        summary: 'She prefers getting to know someone gradually through activities and conversation rather than surface-level excitement.',
        city: 'Lyon',
        education: 'Architecture school',
