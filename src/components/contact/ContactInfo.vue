  ...
  <view class="bg-next-semantic-page-default">
    <view class="mx-auto max-w-[1280px] px-8 py-24">
      <view class="mb-16 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        ...
        <view class="max-w-[440px] text-[18px] italic leading-8 text-next-semantic-text-lead">
          {{ t('info.subtitle') }}
        </view>
      </view>
      ...
      <view class="grid gap-6 lg:grid-cols-3">
        ...
        >
          ...
          <view class="mt-6 border-t border-next-semantic-border-soft pt-5 text-[16px] font-medium text-next-semantic-text-primary">
            {{ t(item.value, { email }) }}
          </view>
        </view>
      </view>
