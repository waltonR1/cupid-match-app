    ...
    <view class="mx-auto max-w-[1280px] px-8 py-24">
      <view class="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
        ...
        <view class="grid gap-6">
          <view class="border border-component-membership-tier-free-card-border bg-component-membership-tier-free-card-background px-7 py-8 shadow-panel">
            <view class="flex flex-wrap items-start justify-between gap-4">
              <view>
                <view class="text-[13px] uppercase tracking-[5px] text-semantic-text-subtle">{{ t('free.badge') }}</view>
            ...
            <view class="mt-6 grid gap-3 md:grid-cols-2">
              <view class="border border-component-membership-tier-free-feature-border bg-component-membership-tier-free-feature-background px-4 py-4 text-[14px] leading-6 text-semantic-text-secondary">
                {{ t('free.f1') }}
              </view>
              <view class="border border-component-membership-tier-free-feature-border bg-component-membership-tier-free-feature-background px-4 py-4 text-[14px] leading-6 text-semantic-text-secondary">
                {{ t('free.f2') }}
          ...
          <view class="border border-component-membership-tier-silver-border bg-gradient-membership-tier-silver-card px-8 py-10 text-semantic-text-primary shadow-panel">
            <view class="text-[13px] uppercase tracking-[5px] text-component-membership-tier-silver-badge-label">{{ t('silver.badge') }}</view>
            ...
            <view class="mt-8 grid gap-3 md:grid-cols-3">
              <view class="border border-component-membership-tier-silver-feature-border bg-component-membership-tier-silver-feature-background px-4 py-4 text-[14px] leading-6 text-semantic-text-secondary">
                {{ t('silver.f1') }}
              </view>
              <view class="border border-component-membership-tier-silver-feature-border bg-component-membership-tier-silver-feature-background px-4 py-4 text-[14px] leading-6 text-semantic-text-secondary">
                {{ t('silver.f2') }}
          ...
          <view class="border border-component-membership-tier-gold-border bg-gradient-membership-tier-gold-card px-8 py-10 text-semantic-text-inverse shadow-emphasis">
            <view class="flex items-start justify-between gap-4">
              <view>
                <view class="text-[13px] uppercase tracking-[5px] text-semantic-text-inverse-subtle">{{ t('gold.badge') }}</view>
              ...
              <view class="rounded-full border border-component-membership-tier-gold-border px-4 py-2 text-[12px] uppercase tracking-[3px] text-component-membership-tier-gold-badge-label">
                {{ t('tiers.popular') }}
              </view>
            </view>
            ...
            <view class="mt-8 grid gap-3 md:grid-cols-3">
              <view class="border border-component-membership-tier-gold-feature-border bg-component-membership-tier-gold-feature-background px-4 py-4 text-[14px] leading-6 text-semantic-text-inverse-muted">
                {{ t('gold.f1') }}
              </view>
              <view class="border border-component-membership-tier-gold-feature-border bg-component-membership-tier-gold-feature-background px-4 py-4 text-[14px] leading-6 text-semantic-text-inverse-muted">
                {{ t('gold.f2') }}
          ...
          <view class="border border-component-membership-tier-diamond-border bg-gradient-membership-tier-diamond-card px-8 py-10 text-semantic-text-inverse shadow-luxe">
            <view class="text-[13px] uppercase tracking-[5px] text-component-membership-tier-diamond-badge-label">{{ t('diamond.badge') }}</view>
            ...
            <view class="mt-8 text-[34px] font-semibold text-semantic-text-inverse">
              {{ t('diamond.price') }}
              <text class="text-[18px] font-normal text-semantic-text-inverse-muted"> {{ t('diamond.priceNote') }}</text>
            </view>
            <view class="mt-2 text-[15px] italic text-semantic-text-inverse-muted">{{ t('diamond.period') }}</view>

            <view class="mt-8 grid gap-3 md:grid-cols-3">
              <view class="border border-component-membership-tier-diamond-feature-border bg-component-membership-tier-diamond-feature-background px-4 py-4 text-[14px] leading-6 text-semantic-text-inverse-muted">
                {{ t('diamond.f1') }}
              </view>
              <view class="border border-component-membership-tier-diamond-feature-border bg-component-membership-tier-diamond-feature-background px-4 py-4 text-[14px] leading-6 text-semantic-text-inverse-muted">
                {{ t('diamond.f2') }}
