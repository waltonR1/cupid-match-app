    ...
    <view class="mx-auto min-h-[640px] max-w-[1280px] px-8 pb-14 pt-10 lg:min-h-[700px] lg:pb-16 lg:pt-12">
      ...
      <view class="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        ...
        <view class="max-w-[620px]">
          ...
          <view
              class="mt-5 max-w-[600px] text-[17px] italic leading-8 text-semantic-text-hero-secondary lg:text-[18px]">
        ...
        <view class="grid gap-5 lg:ml-auto lg:max-w-[560px]">
          <view
              class="border border-semantic-border-hero bg-semantic-surface-hero-panel px-7 py-7 shadow-soft-luxe backdrop-blur">
          ...
          <!-- Hero 补充说明卡片 -->
          <view
              class="border border-semantic-border-hero bg-semantic-surface-hero-soft px-6 py-6 text-[16px] leading-8 text-semantic-text-hero-body backdrop-blur">
            {{ t('hero.card1') }}
          </view>
        </view>
      </view>
