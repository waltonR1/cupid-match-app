<template>
  <view class="text-next-semantic-text-primary">
    <view class="mx-auto max-w-[1280px] px-8 py-24">
      <view class="mb-12 h-px bg-next-component-section-divider-subtle" />

      <view class="mb-12 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <view>
          <view class="text-[12px] uppercase tracking-[5px] text-next-semantic-text-eyebrow">{{ eyebrow }}</view>
      ...
      <view class="grid gap-4">
        ...
        >
          ...
          <view class="pointer-events-none absolute inset-x-0 top-0 h-px bg-next-component-event-card-edge transition-colors duration-300 group-hover:bg-next-component-event-card-edge-hover" />
          ...
          <view class="md:border-l md:border-next-semantic-border-soft md:pl-7">
            <view class="text-[26px] font-semibold text-next-semantic-text-primary transition-colors duration-300 group-hover:text-next-component-event-card-title-hover">{{ event.title }}</view>
