    ...
    <view class="mx-auto max-w-[1280px] px-8 pb-20 pt-10 lg:pb-24 lg:pt-12">
      <view class="grid gap-14 lg:min-h-[620px] lg:grid-cols-[1.08fr_0.92fr] lg:items-start">
        <view class="relative z-10 max-w-[720px]">
          ...
          <view class="mt-4 text-[32px] italic leading-[1.05] text-next-component-hero-title-accent lg:text-[62px]">
            {{ t('hero.titleAccent') }}
          </view>

          <view class="mt-10 max-w-[660px] text-[19px] leading-8 text-next-component-hero-description lg:text-[21px]">
            {{ t('hero.description') }}
          </view>
